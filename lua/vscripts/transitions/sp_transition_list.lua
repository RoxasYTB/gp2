...
CHAPTER_TITLES = {
    ["sp_a1_intro1"] = {
        title_text = "#portal2_Chapter1_Title",
        subtitle_text = "#portal2_Chapter1_Subtitle",
        displayOnSpawn = false,
        displaydelay = 1.0
    },
    ["sp_a2_laser_intro"] = {
        title_text = "#portal2_Chapter2_Title",
        subtitle_text = "#portal2_Chapter2_Subtitle",
        displayOnSpawn = true,
        displaydelay = 2.5
    },
    ["sp_a2_sphere_peek"] = {
        title_text = "#portal2_Chapter3_Title",
        subtitle_text = "#portal2_Chapter3_Subtitle",
        displayOnSpawn = true,
        displaydelay = 2.5
    },
    ["sp_a2_column_blocker"] = {
        title_text = "#portal2_Chapter4_Title",
        subtitle_text = "#portal2_Chapter4_Subtitle",
        displayOnSpawn = true,
        displaydelay = 2.5
    },
    ["sp_a2_bts3"] = {
        title_text = "#portal2_Chapter5_Title",
        subtitle_text = "#portal2_Chapter5_Subtitle",
        displayOnSpawn = true,
        displaydelay = 1.0
    },
    ["sp_a3_00"] = {
        title_text = "#portal2_Chapter6_Title",
        subtitle_text = "#portal2_Chapter6_Subtitle",
        displayOnSpawn = true,
        displaydelay = 1.5
    },
    ["sp_a3_speed_ramp"] = {
        title_text = "#portal2_Chapter7_Title",
        subtitle_text = "#portal2_Chapter7_Subtitle",
        displayOnSpawn = true,
        displaydelay = 1.0
    },
    ["sp_a4_intro"] = {
        title_text = "#portal2_Chapter8_Title",
        subtitle_text = "#portal2_Chapter8_Subtitle",
        displayOnSpawn = true,
        displaydelay = 2.5
    },
    ["sp_a4_finale1"] = {
        title_text = "#portal2_Chapter9_Title",
        subtitle_text = "#portal2_Chapter9_Subtitle",
        displayOnSpawn = false,
        displaydelay = 1.0
    },
}
...
function TryDisplayChapterTitle()
    local level = CHAPTER_TITLES[game.GetMap()]
    if level and level.displayOnSpawn and not shownChapterTitle then DisplayChapterTitle() end
end
...
function OnPostPlayerSpawn(ply)
    ...
    for i, level in ipairs(MapPlayOrder) do
        ...
        if level == FIRST_MAP_WITH_GUN then mapWithGunIndex = i end
        if level == FIRST_MAP_WITH_UPGRADE_GUN then mapWithDualGunIndex = i end
        if level == FIRST_MAP_WITH_POTATO_GUN then mapWithGunPotatoGun = i end
        if i >= mapWithGunIndex and level == map then timer.Simple(0, function() ply:Give("weapon_portalgun") end) end
        if i >= mapWithDualGunIndex and level == map then timer.Simple(0, function() ply:GetActiveWeapon():UpdatePortalGun() end) end
        if i >= mapWithGunPotatoGun and level == map then timer.Simple(0, function() ply:GetActiveWeapon():UpdatePotatoGun(true) end) end
    end
end
