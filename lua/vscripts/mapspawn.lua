...
if IsValid(arrival_elevator_elevator_1) then arrival_elevator_elevator_1:Fire("AddOutput", "OnArrivedAtDestinationNode arrival_elevator-elevator_1,Stop,,0,-1") end
...
if MAPS_WITH_BROKEN_TURRETS[game.GetMap()] then
    ...
    for _, turret in ipairs(turrets) do
        if IsValid(turret:GetPhysicsObject()) then turret:GetPhysicsObject():Sleep() end
    end
end
