...
function TryCloseFinalDoors()
    if closeDoor1 ~= -1 then SealOneArm(closeDoor1, 0) end
    if closeDoor2 ~= -1 then SealOneArm(closeDoor2, 0) end
    if farDoor1 ~= -1 then SealOneArm(farDoor1, 0) end
    if farDoor2 ~= -1 then SealOneArm(farDoor2, 0) end
...
function SealOneArm(arm_number, delay)
    ...
    if arm_number ~= closeDoor1 and arm_number ~= closeDoor2 and arm_number ~= farDoor1 and arm_number ~= finalDoor1 and (arm_number % 3) ~= 0 then
