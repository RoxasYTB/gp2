...
Dialog[100] = {
    speaker = WHEATLEY,
    one = "There you are!",
    two = "I was worried you had gotten yourself murdered",
    nextLine = 101,
    nextLineDelay = 3
}
...
Dialog[101] = {
    speaker = WHEATLEY,
    one = "I needed to get myself on the maintainance crew to see you",
    nextLine = 102,
    nextLineDelay = 2
}
...
Dialog[102] = {
    speaker = WHEATLEY,
    one = "These nanobots workers are pushovers",
    two = "I'm already the only one authorized to weld girders?"
}
...
Dialog[104] = {
    speaker = WHEATLEY,
    one = "What moron put that girder there?!?"
}

Dialog[105] = {
    speaker = WHEATLEY,
    one = "I think I've figured out how to bust you out",
    nextLine = 106,
    nextLineDelay = 3
}
