...
if curMapName == "sp_a3_transition01" then
        ...
        fires = {
            {
                entity = "@glados",
                input = "runscriptcode",
                parameter = "sp_a3_transition01_70sintropart2()",
                fireatstart = true,
                delay = 17.8
            }
        }
    ...
    SceneTable["-1970_05"] = {
        ...
        fires = {
            {
                entity = "offices_caveaudio_trigger",
                input = "enable",
                parameter = "",
                delay = 0
            }
    ...
    SceneTable["-1974_05"] = {
        ...
        fires = {
            ...
            },
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a3_speed_flings_zap()",
                delay = 3.5,
                fireatstart = true
            }
        }
        ...
        fires = {
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a3_portal_intro_yeah01()",
                fireatstart = true,
                delay = 4.7
            },
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a3_portal_intro_yeah02()",
                fireatstart = true,
                delay = 6.9
            },
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a3_portal_intro_yeah03()",
                fireatstart = true,
                delay = 8.0
            },
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a3_portal_intro_take_the_lemons()",
                fireatstart = true,
                delay = 11.2
            },
        }
        ...
        fires = {
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a3_portal_intro_yeah04()",
                fireatstart = true,
                delay = 1.6
            },
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a3_portal_intro_like_this_guy()",
                fireatstart = true,
                delay = 12.1
            },
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a3_portal_intro_burn_house_down()",
                fireatstart = true,
                delay = 18.0
            },
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a3_portal_intro_thinking()",
                fireatstart = true,
                delay = 19.9
            },
        }
...
function sp_a3_transition01_70sintropart2()
    if not sp_a3_transition01_stopCave70sIntro then GladosPlayVcd(-5099) end
end
