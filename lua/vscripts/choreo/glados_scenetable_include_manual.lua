...
if curMapName == "sp_a1_intro1" then
    ...
    SceneTable["-600_01"] = {
        ...
        fires = {
            {
                entity = "container_door_knock_2_relay",
                input = "trigger",
                parameter = "",
                delay = 0.0
            }
    ...
    SceneTable["-600_11"] = {
        ...
        fires = {
            {
                entity = "container_door_knock_3_relay",
                input = "trigger",
                parameter = "",
                delay = 1.0
            }
        ...
        fires = {
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a1_intro1_open_door_nags()",
                delay = 1.0
            }
        }
    }
    ...
    SceneTable["-602_01"] = {
        ...
        fires = {
            --			{entity="are_you_alright_vcd",input="Start",parameter="",delay=0.6},
            {
                ...
                input = "MoveToPathNode",
                parameter = "spherebot_path_inside_hallway",
                delay = 3.5
            },
            {
                entity = "@rl_container_ride_wheatley_enter",
                input = "Trigger",
                parameter = "",
                delay = 3.5
            },
        ...
        fires = {
            {
                entity = "@glados",
                input = "runscriptcode",
                parameter = "sp_a1_intro1_prepare()",
                delay = 5.95,
                fireatstart = true
            },
            {
                entity = "@sphere",
                input = "setidlesequence",
                parameter = "sphere_glance_up_concerned",
                delay = 0.0
            },
        }
    }
    ...
    SceneTable["-602_06"] = {
        ...
        fires = {
            {
                entity = "@rl_container_ride_wheatley_to_hatch",
                input = "trigger",
                parameter = "",
                delay = 0.0,
                fireatstart = true
    ...
    SceneTable["-602_07"] = {
        ...
        fires = {
            {
                entity = "@start_container_engine_rl",
                input = "trigger",
                parameter = "",
                delay = 2.0,
                fireatstart = true
    ...
    SceneTable["-603_05"] = {
        ...
        fires = {
            {
                entity = "sphere_player_has_pressed_space_second",
                input = "Trigger",
                parameter = "",
                delay = 1.5
            },
    ...
    SceneTable["-607_03"] = {
        ...
        fires = {
            {
                entity = "hint_press_spacebar_to_talk",
                input = "ShowHint",
                parameter = "",
                delay = 0.0
            },
            {
                entity = "sphere_player_has_pressed_space_first",
                input = "Enable",
                parameter = "",
                delay = 0.0
            },
...
function sp_a1_intro1_open_door_nags()
    if not sp_a1_intro1_door_opened then GladosPlayVcd(-601) end
end
...
function sp_a1_intro7_PopPortal()
    if not sp_a1_intro7_popped then GladosPlayVcd(469) end
end

function sp_a1_intro7_PopPortalNag()
    if not sp_a1_intro7_popped then GladosPlayVcd(468) end
end

function sp_a1_intro7_ComeThroughNag()
    if not sp_a1_intro7_camethrough then GladosPlayVcd(470) end
end
...
function sp_a1_intro7_PickMeUpNag()
    if not sp_a1_intro7_pickedup then GladosPlayVcd(474) end
end
...
function sp_a1_intro7_PlugMeInNag()
    if not sp_a1_intro7_pluggedin then GladosPlayVcd(476) end
end
...
function sp_a1_intro7_NoWatchingNag()
    if not sp_a1_intro7_turnedaway then GladosPlayVcd(481) end
end
...
function sp_a1_wakeup_come_through_here()
    if sp_a1_wakeup_Looked_Down then GladosPlayVcd(586) end
end
...
function sp_a1_wakeup_Lets_Go_In()
    if notsp_a1_wakeup_In_Breaker_Room then GladosPlayVcd(585) end
end
...
if curMapName == "sp_a2_trust_fling" then
    ...
    SceneTable["-303_01"] = {
        ...
        fires = {
            {
                entity = "button_press_dialog_relay",
                input = "trigger",
                parameter = "",
                delay = 0.5
            }
...
if curMapName == "sp_a2_pit_flings" then
    ...
    SceneTable["sp_a2_pit_flingsCubeSmuggleEnding02"] = {
        ...
        fires = {
            {
                entity = "smuggled_cube_fizzle_trigger",
                input = "enable",
                parameter = "",
                delay = 0.0
            },
            {
                entity = "glados_summon_elevator_relay",
                input = "trigger",
                parameter = "",
                delay = 0.5,
                fireatstart = true
...
-- sp_a2_sphere_peek
-- ****************************************************************************************************
if curMapName == "sp_a2_sphere_peek" then peekctr = 0 end
...
if curMapName == "sp_a2_bridge_the_gap" then
    ...
    SceneTable["-500_00"] = {
        ...
        fires = {
            {
                entity = "start_wheatley_window_scene_relay",
                input = "trigger",
                parameter = "",
                delay = 3.0
            }
    ...
    SceneTable["-500_02"] = {
        ...
        fires = {
            {
                entity = "bird_attack_start_relay",
                input = "Trigger",
                parameter = "",
                delay = 3.6,
                fireatstart = true
    ...
    SceneTable["-500_05"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/sp_a2_bridge_the_gap_expo01.vcd"),
        postdelay = 0.1,
        next = "-500_06",
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-500_06"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/sp_a2_bridge_the_gap_expo03.vcd"),
        postdelay = 0.4,
        next = "-500_07",
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-500_07"] = {
        ...
        fires = {
            ...
            {
                entity = "wheatley_depart_scene_relay",
                input = "Trigger",
                parameter = "",
                delay = 3,
                fireatstart = true
...
if curMapName == "sp_a2_column_blocker" then
    SceneTable["-400_01"] = {
        ...
        fires = {
            {
                entity = "surprise_room_lights_on",
                input = "Trigger",
                parameter = "",
                delay = 0.2
            },
    ...
    SceneTable["-401_01"] = {
        ...
        fires = {
            {
                entity = "surprise_room_effects_relay",
                input = "Trigger",
                parameter = "",
                delay = 0.6
            },
            {
                entity = "surprise_room_party_horn_sound",
                input = "playsound",
                parameter = "",
                delay = 0.3
            }
    ...
    SceneTable["-403_01"] = {
        ...
        fires = {
            {
                entity = "surprise_room_door_relay",
                input = "trigger",
                parameter = "",
                delay = 1.5,
                fireatstart = true
...
-- sp_a2_bts1
-- ****************************************************************************************************
if curMapName == "sp_a2_bts1" then sp_a2_bts1_FakeEntered = false end
...
function bts4_redemption_line_turret_pickup()
    ...
    if not sp_a2_bts4_redemption_turret_babbling then GladosPlayVcd(614, nil, "conveyor_turret_body") end
end
...
function bts4_redemption_line_turret_babble_end()
    ...
    sp_a2_bts4_redemption_turret_babbling = false
    if sp_a2_bts4_redemption_turret_held then EntFire("@glados", "runscriptcode", "bts4_redemption_line_turret_babble()", dly) end
end
...
function FactoryScannerIntro()
    ...
    if not sp_a2_bts4_Intro_Talking then GladosPlayVcd(519) end
end
...
function FactoryCheckAtWindowEnd()
    sp_a2_bts4_Intro_Talking = false
    if sp_a2_bts4_At_Window then FactoryScannerSpeech() end
end
...
function FactoryStillThinkingNag()
    ...
    if sp_a2_bts4_StillThinkingNagStage == 0 then
        if not sp_a2_bts4_StillThinkingNagOK then return end
...
function FactoryWhereAreYouGoing()
    if not sp_a2_bts4_MentionedSwap then GladosPlayVcd(532) end
end

function FactoryWhereAreYouGoingTwo()
    if not sp_a2_bts4_MentionedSwap then GladosPlayVcd(533) end
end
...
function FactoryWheatleyShoutout()
    if not sp_a2_bts4_MentionedSwap then GladosPlayVcd(541) end
end

function FactoryEnterScannerRoomWithTurret()
    if not sp_a2_bts4_MentionedSwap then GladosPlayVcd(540) end
end
...
if curMapName == "sp_a2_bts4" or curMapName == "sabotage_offices" then
    ...
    SceneTable["-101_02"] = {
        ...
        fires = {
            ...
            {
                entity = "lookat_potato_exhibits_relay",
                input = "trigger",
                parameter = "",
                delay = 0.2,
                fireatstart = true
            ...
            {
                entity = "wheatley_exhibit_move_triggers",
                input = "enable",
                parameter = "",
                delay = 4.0,
                fireatstart = true
    ...
    SceneTable["-103_01"] = {
        ...
        fires = {
            {
                entity = "lookat_deadend_relay", -- aim light down deadend
                input = "trigger",
                parameter = "",
                delay = 2.0,
                fireatstart = true
            ...
            {
                entity = "move_wheatley_to_deadend_relay", -- move towards deadend
                input = "trigger",
                parameter = "",
                delay = 3.0,
                fireatstart = true
            ...
            {
                entity = "lookat_deadend_entry_relay", -- aim light back
                input = "trigger",
                parameter = "",
                delay = 3.7,
                fireatstart = true
            ...
            {
                entity = "move_wheatley_to_exit_relay", -- move out of deadend
                input = "trigger",
                parameter = "",
                delay = 4.0,
                fireatstart = true
...
-- sp_a2_bts5
-- ****************************************************************************************************
if curMapName == "sp_a2_bts5" then bts5_cuts = 0 end
if curMapName == "sp_a2_bts5" then bts5_cuts = 0 end
...
function sp_a2_core_leave_annex_nag()
    if not sp_a2_core_xfer_left_annex then GladosPlayVcd(-45) end
end
...
if curMapName == "sp_a2_core" then -- TODO: CHANGE THIS TO CORRECT MAP NAME
    ...
    SceneTable["-20_03"] = {
        ...
        fires = {
            {
                entity = "rv_start_moving_trigger",
                input = "enable",
                parameter = "",
                delay = 0.5
            }
    ...
    SceneTable["-21_02"] = {
        ...
        fires = {
            {
                entity = "glados_chamber_body", -- ANIM
                input = "setanimation",
                parameter = "gladosbattle_firstpart",
                delay = 0,
                fireatstart = true
            },
            {
                ...
                parameter = "glados_idle_rightside",
                delay = 0,
                fireatstart = true
            }
        }
    ...
    SceneTable["-700_02"] = {
        ...
        fires = {
            {
                entity = "box_turret_push_trigger", -- turret falls over
                input = "enable",
                parameter = "",
                delay = 0.0,
                fireatstart = true
    ...
    SceneTable["-700_03"] = {
        ...
        fires = {
            {
                entity = "turret_01-chamber_npc_turret_guns_out_ss", -- pop out guns
                input = "beginsequence",
                parameter = "",
                delay = 0,
                fireatstart = true
            ...
            {
                entity = "turret_01-chamber_npc_turret",
                input = "ignite",
                parameter = "",
                delay = 0
            },
    ...
    SceneTable["-700_05"] = {
        ...
        fires = {
            {
                entity = "turret_01-chamber_npc_turret",
                input = "selfdestructimmediately",
                parameter = "",
                delay = 0.0
            },
            {
                entity = "turret_02-chamber_npc_turret",
                input = "ignite",
                parameter = "",
                delay = 0.1
            }
    ...
    SceneTable["-700_07"] = {
        ...
        fires = {
            {
                entity = "turret_03-chamber_npc_turret",
                input = "selfdestruct",
                parameter = "",
                delay = 0,
                fireatstart = true
    ...
    SceneTable["-700_08"] = {
        ...
        fires = {
            {
                entity = "turret_04-chamber_npc_turret_guns_out_ss", -- pop out guns
                input = "beginsequence",
                parameter = "",
                delay = 0,
                fireatstart = true
    ...
    SceneTable["-700_09"] = {
        ...
        fires = {
            {
                entity = "turret_05 -chamber_npc_turret_guns_out_ss", -- pop out guns
                input = "beginsequence",
                parameter = "",
                delay = 0,
                fireatstart = true
    ...
    SceneTable["-700_10"] = {
        ...
        fires = {
            {
                entity = "turret_04-chamber_npc_turret",
                input = "ignite",
                parameter = "",
                delay = 0,
                fireatstart = true
            ...
            {
                entity = "turret_05-chamber_npc_turret",
                input = "ignite",
                parameter = "",
                delay = 0
            },
    ...
    SceneTable["-700_11"] = {
        ...
        fires = {
            ...
            },
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "TurretDeathReactionDialog()",
                delay = 0.3
            }
        }
    }
    ...
    SceneTable["-22_03"] = {
        ...
        fires = {
            {
                entity = "deploy_neurotoxin_tube_relay",
                input = "Trigger",
                parameter = "",
                delay = 5.00,
                fireatstart = true
    ...
    SceneTable["-22_05"] = {
        ...
        fires = {
            ...
            --{entity="glados_watch_wheatley_deploy_relay",input="Trigger",parameter="",delay=0.4} -- makes glados spin to watch wheatley
            {
                entity = "@glados",
                input = "runscriptcode",
                parameter = "StartWheatleyNeurotoxinRideNag()",
                delay = 0.00
            }
        }
    }
...
SceneTable["-23_01"] = {
    ...
    fires = {
        {
            entity = "shatter_vault_glass_relay",
            input = "Trigger",
            parameter = "",
            delay = 0.4
        }
...
SceneTable["-23_04"] = {
    ...
    fires = {
        ...
        },
        {
            entity = "glados_chamber_body",
            input = "setdefaultanimation",
            parameter = "glados_idle_agitated_more",
            delay = 0,
            fireatstart = true
        }
    }
...
SceneTable["-23_07"] = {
    ...
    fires = {
        {
            entity = "deploy_core_receptacle_relay",
            input = "Trigger",
            parameter = "",
            delay = 0.3,
            fireatstart = true
        ...
        {
            entity = "display_socket_instructions_relay",
            input = "Trigger",
            parameter = "",
            delay = 0.3,
            fireatstart = true
    ...
    fires = {
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "StartWheatleyPluginScene()",
            delay = 0.0
        }
    }
}
...
SceneTable["-760_01c"] = {
    ...
    fires = {
        ...
        },
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "StartWheatleyPluginNag()",
            delay = 0
        }
    }
}
...
-- ======================================
SceneTable["-760_01d"] = {
    vcd = CreateSceneEntity("scenes/npc/sphere03/fgb_doit_nags09.vcd"),
    ...
    idle = true,
    talkover = true,
    idlegroup = "socketwheatleynag",
    idleorderingroup = 1,
    idleunder = 1
}

SceneTable["-760_02"] = {
    vcd = CreateSceneEntity("scenes/npc/sphere03/fgb_plugin_nags06.vcd"),
    postdelay = 0.1,
    next = "-760_02a",
    char = "wheatley",
    noDingOff = true,
...
SceneTable["-760_02a"] = {
    vcd = CreateSceneEntity("scenes/npc/glados/gladosbattle_xfer13.vcd"),
    postdelay = 0.1,
    next = "-760_02b",
    char = "glados",
    noDingOff = true,
...
SceneTable["-760_02b"] = {
    vcd = CreateSceneEntity("scenes/npc/sphere03/fgb_doit_nags06.vcd"),
    postdelay = 0.1,
    next = "-760_02c",
    char = "wheatley",
    noDingOff = true,
...
SceneTable["-760_02c"] = {
    vcd = CreateSceneEntity("scenes/npc/sphere03/fgb_doit_nags03.vcd"),
    postdelay = 1.0,
    next = nil,
    char = "wheatley",
    noDingOff = true,
...
SceneTable["-760_03"] = {
    vcd = CreateSceneEntity("scenes/npc/sphere03/fgb_plugin_nags08.vcd"),
    postdelay = 0.1,
    next = "-760_03a",
    char = "wheatley",
    noDingOff = true,
...
SceneTable["-760_03a"] = {
    vcd = CreateSceneEntity("scenes/npc/glados/sp_a2_core03.vcd"),
    postdelay = 0.1,
    next = nil,
    char = "glados",
    noDingOff = true,
...
SceneTable["-760_04"] = {
    vcd = CreateSceneEntity("scenes/npc/sphere03/fgb_plugin_nags07.vcd"),
    postdelay = 0.1,
    next = "-760_04a",
    char = "wheatley",
    noDingOff = true,
...
SceneTable["-760_04a"] = {
    vcd = CreateSceneEntity("scenes/npc/glados/sp_a2_core04.vcd"),
    postdelay = 0.1,
    next = nil,
    char = "glados",
    noDingOff = true,
...
SceneTable["-760_05"] = {
    vcd = CreateSceneEntity("scenes/npc/sphere03/fgb_plugin_nags05.vcd"),
    postdelay = 0.1,
    next = "-760_05a",
    char = "wheatley",
    noDingOff = true,
...
SceneTable["-760_06"] = {
    vcd = CreateSceneEntity("scenes/npc/sphere03/fgb_plugin_nags09.vcd"),
    postdelay = 0.1,
    next = "-760_06a",
    char = "wheatley",
    noDingOff = true,
...
SceneTable["-760_07"] = {
    vcd = CreateSceneEntity("scenes/npc/sphere03/fgb_plugin_nags11.vcd"),
    postdelay = 0.1,
    next = "-760_07a",
    char = "wheatley",
    noDingOff = true,
...
SceneTable["-24_01"] = {
    ...
    fires = {
        {
            entity = "core_transfer_nag_relay",
            input = "kill",
            parameter = "",
            delay = 0.0,
            fireatstart = true
    ...
    fires = {
        {
            entity = "@glados",
            input = "runscriptcode",
            parameter = "sp_sabotage_glados_specials(1)",
            delay = 0.7
        },
        {
            entity = "glados_chamber_body", -- ANIM
            input = "setanimation",
            parameter = "gladosbattle_xfer07",
            delay = 0,
            fireatstart = true
        },
        {
    ...
    fires = {
        {
            entity = "@glados",
            input = "runscriptcode",
            parameter = "sp_sabotage_glados_specials(2)",
            delay = 0.3,
            fireatstart = true
        }
    }
...
SceneTable["-24_09"] = {
    ...
    fires = {
        {
            entity = "open_stalemate_room_doors_relay",
            input = "trigger",
            parameter = "",
            delay = 0.0
        },
        {
            entity = "display_button_press_instructions_relay",
            input = "Trigger",
            parameter = "",
            delay = 0.0
        }
    ...
    fires = {
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "StartStalemateButtonPressNag()",
            delay = 0
        }
    }
}
    ...
    fires = {
        {
            entity = "@glados",
            input = "runscriptcode",
            parameter = "sp_a2_core_leave_annex_nag()",
            delay = 7.0
        }
    }
}
    ...
    fires = {
        {
            entity = "glados_chamber_body", -- ANIM
            input = "setanimation",
            parameter = "Sp_sabotage_glados_dropped",
            delay = 0,
            fireatstart = true
        },
        {
    ...
    fires = {
        {
            entity = "glados_chamber_body", -- ANIM
            input = "setanimation",
            parameter = "fgbwheatleytransfer03",
            delay = 0,
            fireatstart = true
        },
        {
...
SceneTable["-4_05"] = {
    ...
    fires = {
        {
            entity = "maintenance_pit_script",
            input = "RunScriptCode",
            parameter = "OpenMaintenancePitDoor()",
            delay = 0.7,
            fireatstart = true
        },
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "PitHandsGrabGladosHead()",
            delay = 3.0,
            fireatstart = true
        },
        {
            entity = "glados_pit_player_clip_relay", -- pushes player off of maintenance pit
            input = "trigger",
            parameter = "",
            delay = 0.8,
            fireatstart = true
        ...
        {
            entity = "@glados", -- idon't know this is just hack to prevent wheatley speaking twice :/ and breaking whole sequence
            input = "RunScriptCode",
            parameter = "GladosCharacterStopScene('wheatley')",
            delay = 0.2
        }
    }
}
...
SceneTable["-27_00"] = {
    ...
    fires = {
        {
            entity = "pitgrab_player_looking_at_glados_aisc",
            input = "enable",
            parameter = "",
            delay = 0
        }
...
SceneTable["-27_01"] = {
    ...
    fires = {
        {
            entity = "glados_head_removal_spark_timer",
            input = "enable",
            parameter = "",
            delay = 1,
            fireatstart = true
        ...
        },
        {
            entity = "maintenance_pit_script",
            input = "RunScriptCode",
            parameter = "EjectGladosHead()",
            delay = 0.0
        },
        {
            entity = "begin_wheatley_emergence_relay",
            input = "trigger",
            parameter = "",
            delay = 2.0
        },
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "CoreTransferCompleted()",
            delay = 2.5
        },
        {
            entity = "maintenance_pit_script",
            input = "RunScriptCode",
            parameter = "RevealWheatley()",
            delay = 2.0
        },
    }
}
...
SceneTable["-5_01"] = {
    ...
    fires = {
        {
            entity = "wheatley_body", -- ANIM
            input = "setanimation",
            parameter = "glados_wheatley_body_intro01",
            delay = 0,
            fireatstart = true
        },
        {
    ...
    fires = {
        {
            entity = "@glados", -- ANIM
            input = "RunScriptCode",
            parameter = "CoreRoomHappyCounterClockwiseAnim()",
            delay = 1,
            fireatstart = true
        }
    }
...
SceneTable["-5_03"] = {
    ...
    fires = {
        {
            entity = "deploy_exit_elevator_relay",
            input = "Trigger",
            parameter = "",
            delay = 0.0,
            fireatstart = true
    ...
    fires = {
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "StartWheatleyElevatorNag()",
            delay = 3.0
        }
    }
}
    ...
    fires = {
        {
            entity = "wheatley_body", -- ANIM
            input = "setanimation",
            parameter = "glados_wheatley_heel_turn07",
            delay = 0,
            fireatstart = true
        },
        {
            entity = "start_juggling_relay",
            input = "Trigger",
            parameter = "",
            delay = 3,
            fireatstart = true
        ...
        },
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "CoreRoomHappyFlappingAnim()",
            delay = 3,
            fireatstart = true
        }
    }
...
SceneTable["-14_06"] = {
    ...
    fires = {
        {
            entity = "move_exit_elevator_to_escape_vista_relay",
            input = "Trigger",
            parameter = "",
            delay = 0.2
        }
    ...
    fires = {
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "CoreRoomEvilLaughPanelAnim()",
            delay = 1.5,
            fireatstart = true
        }
    }
...
SceneTable["-14_10"] = {
    ...
    fires = {
        {
            entity = "move_exit_elevator_to_smash_start",
            input = "Trigger",
            parameter = "",
            delay = 3.5,
            fireatstart = true
        ...
        {
            entity = "wheatly_turns_evil_relay",
            input = "Trigger",
            parameter = "",
            delay = 3.5,
            fireatstart = true
    ...
    fires = {
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "DialogDuringPotatosManufacture()",
            delay = 0.5
        }
    }
}
...
SceneTable["-10_01"] = {
    ...
    fires = {
        -- pop out the panels to look at player
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "CoreRoomPanelLookAnim()",
            delay = 1.8,
            fireatstart = true
        },
        {
            entity = "wheatley_evil_lightson_sound",
            input = "playsound",
            parameter = "",
            delay = 1.8,
            fireatstart = true
        },
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "CoreRoomPanelLookTurnRed()",
            delay = 2.3,
            fireatstart = true
        },
        -- start turn scene
        {
            entity = "maintenance_pit_script", -- long delay. This opens the doors and puts the little hands up with the potato.
            input = "RunScriptCode",
            parameter = "PresentPotatos()",
            delay = 14,
            fireatstart = true
        },
        {
            entity = "maintenance_pit_script", -- pincer shows up, takes potato from small arms
            input = "RunScriptCode",
            parameter = "DeliverPotatos()",
            delay = 0
        },
        {
            entity = "@glados", -- starts the "ah! see that?" scene
            input = "RunScriptCode",
            parameter = "PotatosPresentation()",
            delay = 2
        },
        {
            entity = "potato_factory_effects_start_relay",
            input = "trigger",
            parameter = "",
            delay = 0,
            fireatstart = true
        ...
        {
            entity = "potato_factory_effects_stop_relay",
            input = "trigger",
            parameter = "",
            delay = 0
        },
        {
            entity = "glados_detached_head", -- deletes glados's head
            input = "kill",
            parameter = "",
            delay = 3.5,
            fireatstart = true
        ...
        {
            entity = "maintenance_pit_script", -- deletes all but the small pit arms
            input = "RunScriptCode",
            parameter = "DeletePitArms()",
            delay = 5,
            fireatstart = true
        },
        {
            entity = "maintenance_pit_script", -- enables visibility on the pincer arm
            input = "RunScriptCode",
            parameter = "EnablePincer()",
            delay = 0,
            fireatstart = true
        },
        {
            entity = "potatos_arrival_chime", -- sound when potatos shows up
            input = "playsound",
            parameter = "",
            delay = 1.5
        }
    ...
    fires = {
        {
            entity = "@glados",
            input = "RunScriptCode",
            parameter = "CoreRoomPanelReturnToNormalAnim()",
            delay = 0
        }
    }
}
...
SceneTable["-11_03"] = {
    ...
    fires = {
        -- {entity="@glados",input="RunScriptCode",parameter="PotatosPresentation()",delay=0, fireatstart=true },
        {
            entity = "maintenance_pit_script",
            input = "RunScriptCode",
            parameter = "WigglePotatosMultiple()",
            delay = 0.0,
            fireatstart = true
        },
        {
            entity = "maintenance_pit_script",
            input = "RunScriptCode",
            parameter = "TapGladosGentlyOnGlass()",
            delay = 1.4,
            fireatstart = true
        }
    }
...
SceneTable["-11_05"] = {
    ...
    fires = {
        {
            entity = "begin_potatos_moron_scene_relay",
            input = "Trigger",
            parameter = "",
            delay = 0.5
        }
    ...
    fires = {
        {
            entity = "maintenance_pit_script",
            input = "RunScriptCode",
            parameter = "TapGladosStronglyOnGlass()",
            delay = 0.6,
            fireatstart = true
        }
    }
    ...
    fires = {
        {
            entity = "maintenance_pit_script",
            input = "RunScriptCode",
            parameter = "PunchGladosThroughGlass()",
            delay = 0.5,
            fireatstart = true
        },
        {
            entity = "begin_elevator_conclusion_relay",
            input = "Trigger",
            parameter = "",
            delay = 0.0
        }
...
SceneTable["-13_01"] = {
    ...
    fires = {
        {
            entity = "exit_elevator_groan_sound",
            input = "playsound",
            parameter = "",
            delay = 0.2
        },
        {
            entity = "elevator_prebreak_shake",
            input = "startshake",
            parameter = "",
            delay = 0.2
        }
    ...
    fires = {
        {
            entity = "@command",
            input = "command",
            parameter = "map_wants_save_disable 0",
            delay = 1.0
        },
        {
            entity = "begin_elevator_collapse_relay",
            input = "Trigger",
            parameter = "",
            delay = 0.0
        },
        {
            entity = "ghostAnim_potatos",
            input = "setanimation",
            parameter = "reach1_fall",
            delay = 0.0
        }
    }
}
