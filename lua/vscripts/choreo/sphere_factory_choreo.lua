...
Dialog[1000] = {
    speaker = "WHEATLEY",
    one = "Hey! You made it through!"
}

Dialog[1001] = {
    speaker = "WHEATLEY",
    one = "You have to come see what i've found."
}

Dialog[1101] = {
    speaker = "WHEATLEY",
    one = "You're not gonna believe this..."
}

Dialog[1104] = {
    speaker = "WHEATLEY",
    one = "Check it out!  It is the  turret quality control room!"
}

Dialog[2000] = {
    speaker = "WHEATLEY",
    one = "That thing out there is the quality control scanner.",
    two = "It is deciding which turrets to keep and which to toss.",
    nextLine = 2010,
    nextLineDelay = 4
}
...
Dialog[2010] = {
    speaker = "WHEATLEY",
    one = "We need to change the scanner so it stops working."
}

Dialog[2015] = {
    speaker = "WHEATLEY",
    one = "Let me see if I can grant us access to the control panel."
}

Dialog[2020] = {
    speaker = "WHEATLEY",
    one = "There.  Now we can get inside!"
}

Dialog[2025] = {
    speaker = "WHEATLEY",
    one = "See if you can find a way to unplug the turret Template."
}

Dialog[2030] = {
    speaker = "WHEATLEY",
    one = "Try to unplug that turret in there."
}

Dialog[2035] = {
    speaker = "COMPUTER",
    one = "Template disconnected.  Using last stored template.",
    two = "Insert new Template to change turret control settings."
}

Dialog[2037] = {
    speaker = "COMPUTER",
    one = "Using last stored template.",
    two = "Please insert new Template to change turret settings."
}

Dialog[2040] = {
    speaker = "WHEATLEY",
    one = "Ahh, the computer must have the old Template in memory.",
    two = "We need to find a new one!"
}

Dialog[2045] = {
    speaker = "WHEATLEY",
    one = "Grab one of those rejected turrets.",
    two = "Maybe we can use it as a Template!"
}

Dialog[2050] = {
    speaker = "WHEATLEY",
    one = "We need to get one of those rejected turrets plugged into the computer."
}
...
Dialog[2065] = {
    speaker = "WHEATLEY",
    one = "Wow, you caught one ugly turret.",
    nextLine = 2067,
    nextLineDelay = 3
}
...
Dialog[2080] = {
    speaker = "COMPUTER",
    one = "Template Accepted.",
    two = "Template, are you ready to accept the procedure?",
    nextLine = 2085,
    nextLineDelay = 3
}
...
Dialog[2090] = {
    speaker = "COMPUTER",
    one = "...",
    two = "New Template Accepted."
}

Dialog[2095] = {
    speaker = "WHEATLEY",
    one = "All Right!  This is working better than expected."
}

Dialog[2100] = {
    speaker = "WHEATLEY",
    one = "GLaDOS won't know the turrets are defective until it's too late."
}

Dialog[2105] = {
    speaker = "WHEATLEY",
    one = "Let me open the door so we can get out of here."
}

Dialog[1002] = {
    speaker = "WHEATLEY",
    one = "Great! Wait here until all the live turrets are gone"
}

Dialog[1003] = {
    speaker = "WHEATLEY",
    one = "Drop down here onto this track"
}

Dialog[1004] = {
    speaker = "WHEATLEY",
    one = "Stop there! I'll show you where to go from here"
}

Dialog[1005] = {
    speaker = "WHEATLEY",
    one = "Follow me to the neurotoxin"
}
