...
if curMapName == "sp_a3_00" then
    ...
    SceneTable["-3000_11"] = {
        ...
        fires = {
            {
                entity = "@shaft_potatos_ledge_start",
                input = "Trigger",
                parameter = "",
                delay = 2.0,
                fireatstart = true
            ...
            {
                entity = "@shaft_crash_landing_start",
                input = "Trigger",
                parameter = "",
                delay = 6.0,
                fireatstart = true
            ...
            {
                entity = "potatos_end_relay", -- force transition in case train fails
                input = "Trigger",
                parameter = "",
                delay = 10.0
            }
        ...
        fires = {
            {
                entity = "@glados",
                input = "runscriptcode",
                parameter = "sp_a3_transition01_peck()",
                delay = 1.0
            }
        }
    }
...
if curMapName == "sp_a3_transition01" then
    ...
    SceneTable["-3121_04"] = {
        ...
        fires = {
            {
                entity = "sphere_entrance_potatos_button",
                input = "Unlock",
                parameter = "",
                delay = 0.0
            },
...
if curMapName == "sp_a3_end" then
    ...
    SceneTable["-3125_01"] = {
        ...
        fires = {
            {
                entity = "big_door_open_relay_counter",
                input = "add",
                parameter = "1",
                delay = 0.0
            }
...
function sp_a3_transition01_birdidle()
    if not sp_a3_transition01_bird_flew_away then EntFire("bird", "SetAnimation", "nest_idle", 0.0) end
end
