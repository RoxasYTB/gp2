...
if curMapName == "sp_a4_intro" then
    ...
    SceneTable["-4004_03"] = {
        ...
        fires = {
            {
                entity = "wheatley_screen_off_relay",
                input = "Trigger",
                parameter = "",
                delay = 0.0
            },
            {
                entity = "cubetest_scene_cancel_relay",
                input = "Disable",
                parameter = "",
                delay = 0.0
            },
            {
                entity = "solve_scene_cancel_relay",
                input = "Disable",
                parameter = "",
                delay = 0.0
            },
            {
                entity = "entrance_door_relay",
                input = "Trigger",
                parameter = "",
                delay = 0.0
            },
    ...
    SceneTable["-4007_06"] = {
        ...
        fires = {
            {
                entity = "turret_bot1_monster",
                input = "BecomeShortcircuit",
                parameter = "",
                delay = 4.0,
                fireatstart = true
            },
            {
                entity = "turret_bot2_monster",
                input = "BecomeShortcircuit",
                parameter = "",
                delay = 4.25,
                fireatstart = true
    ...
    -- Alright, get moving.
    SceneTable["-4008_01"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_fire_lift02.vcd"),
        idlerepeat = true,
        postdelay = 0.1,
        next = null,
        char = "wheatley",
    ...
    SceneTable["-4008_03"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_paradox11.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4008_04"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_leave_nags01.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4009_05"] = {
        ...
        fires = {
            {
                entity = "test_chamber1_slow_relay",
                input = "Disable",
                parameter = "",
                delay = 0.0,
                fireatstart = true
            ...
            {
                entity = "test_chamber1_fast_relay",
                input = "Enable",
                parameter = "",
                delay = 0.0,
                fireatstart = true
    ...
    -- Go on.
    SceneTable["-4021_01"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_sp_a4_intro_moat04.vcd"),
        postdelay = 0.3,
        next = null,
        char = "wheatley",
        idleminsecs = 6.0,
        ...
        noDingOn = true,
        idle = true,
        idlegroup = "test1hints",
        idleorderingroup = 1
    }

    SceneTable["-4021_02"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_first_test_solve_nags02.vcd"),
        postdelay = 0.3,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4021_03"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_first_test_solve_nags03.vcd"),
        postdelay = 3.4,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4021_04"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test_solve_nags01.vcd"),
        postdelay = 3.4,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4021_05"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags01.vcd"),
        postdelay = 3.4,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4021_06"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags02.vcd"),
        postdelay = 3.4,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4021_07"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags03.vcd"),
        postdelay = 3.4,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4021_08"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags04.vcd"),
        postdelay = 0.0,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4022_01"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_sp_a4_intro_notdone01.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
        ...
        idleminsecs = 8.0,
        idlemaxsecs = 12.0,
        idlegroup = "test1finishhints",
        idleorderingroup = 1
    }

    SceneTable["-4022_02"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_sp_a4_intro_notdone02.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4022_03"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags06.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4022_04"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_sp_a4_intro_notdone04.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4022_05"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags07.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4019_01"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test01.vcd"),
        idlerepeat = true,
        postdelay = 0.1,
        next = null,
        char = "wheatley",
    ...
    SceneTable["-4019_02"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test_solve_nags02.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4019_03"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test_solve_nags03.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4019_04"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test_solve_nags04.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4019_05"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test_solve_nags05.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
        ...
        fires = {
            {
                entity = "@glados",
                input = "RunScriptCode",
                parameter = "sp_a4_stop_the_box_intro_over()",
                delay = 0.0
            }
        }
    }
...
if curMapName == "sp_a4_speed_tb_catch" then
    ...
    SceneTable["-4448_01"] = {
        ...
        fires = {
            {
                entity = "start_chamber_destruction",
                input = "Trigger",
                parameter = "",
                delay = 15.5,
                fireatstart = true
...
if curMapName == "sp_a4_finale3" then
    ...
    SceneTable["-4852_01"] = {
        ...
        fires = {
            {
                entity = "wheatley_studio-wheatley_leave_relay",
                input = "Trigger",
                parameter = "",
                delay = 2.3,
                fireatstart = true
            ...
            {
                entity = "wheatley_studio-wheatley_return_relay",
                input = "Trigger",
                parameter = "",
                delay = 3.0,
                fireatstart = true
...
if curMapName == "sp_a4_finale4" then
    ...
    SceneTable["-2298_01"] = {
        ...
        fires = {
            ...
            {
                entity = "wheatley_shield",
                input = "setlocalorigin",
                parameter = "13.1 277.2 -31.0",
                delay = 3.0
            },
            {
                entity = "wheatley_shield",
            ...
            {
                entity = "futbol_shooter",
                input = "setlocalorigin",
                parameter = "1.7 75.0 -116.6",
                delay = 3.0
            },
            {
                entity = "futbol_shooter",
                input = "setlocalangles",
                parameter = "86.5 158.6 66.5",
                delay = 3.0
            },
            {
                entity = "wheatley_shadow_brush",
                input = "setlocalorigin",
                parameter = "6.0 12.5 -10.0",
                delay = 3.0
            },
            {
                entity = "wheatley_shadow_brush",
    ...
    SceneTable["-4940_01"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags01.vcd"),
        idlerepeat = true,
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        ...
        idleminsecs = 6.0,
        idlemaxsecs = 8.0,
        idlegroup = "stalemate_buttonnags",
        idleorderingroup = 1
    }

    SceneTable["-4940_02"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags02.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4940_03"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags03.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4940_04"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags04.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4940_05"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags05.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
    ...
    SceneTable["-4940_06"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags06.vcd"),
        postdelay = 0.1,
        next = null,
        char = "wheatley",
        noDingOff = true,
...
if curMapName == "sp_a4_intro" then sp_a4_intro_startwheatleytest2nag_started = false end
...
function stop_the_box_missed()
    if sp_a4_stop_the_box_check_smash() then if sp_a4_stop_the_box_intro_played then GladosPlayVcd(-4415) end end
end
...
function BBExtraDialogA()
    if not sp_a4_finale4_extradialoga then
...
function BBExtraDialogB()
    if not sp_a4_finale4_extradialogb then
...
if curMapName == "sp_a4_finale4" or curMapName == "core_test1" then
    ...
    SceneTable["altwakeupthree01a"] = {
        vcd = CreateSceneEntity("scenes/npc/sphere03/bw_finale04_thorn01.vcd"),
        postdelay = -3.5,
        next = "altwakeupthree01b",
        char = "wheatley",
        noDingOff = true,
        noDingOn = true
    }
    ...
    SceneTable["altwakeupthree01b"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble26.vcd"),
        postdelay = 0.0,
        next = "altwakeupthree02",
        char = "core03",
        noDingOff = true,
        noDingOn = true,
        talkover = true
    ...
    SceneTable["-7100_01"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble20.vcd"),
        idlerepeat = true,
        postdelay = 0.01,
        next = null,
        char = "core01",
        ...
        idleminsecs = 0.00,
        idlemaxsecs = 0.08,
        idlegroup = "core01_babble",
        idleorderingroup = 1
    }

    --Ba! Ba! Ba ba ba! Space! Ba! Ba! Ba ba ba!
    SceneTable["-7100_02"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble24.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_03"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble28.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_04"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble29.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_05"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble33.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_06"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble67.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_07"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble58.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_08"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble105.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_09"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble102.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_10"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble62.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_11"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble05.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_12"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble16.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_13"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble19.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_14"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble11.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space...
    SceneTable["-7100_15"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble14.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space space wanna go to space
    SceneTable["-7100_16"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble21.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_17"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble22.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_18"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble31.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space. Space.
    SceneTable["-7100_19"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble35.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --I'm going to space.
    SceneTable["-7100_20"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble36.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Oh boy.
    SceneTable["-7100_21"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble37.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Yeah yeah okay okay.
    SceneTable["-7100_22"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble40.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_23"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble42.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_24"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble43.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Yes. Please. Space.
    SceneTable["-7100_25"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble44.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_26"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble45.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Ba! Ba! Ba ba ba! Space!
    SceneTable["-7100_27"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble46.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Gonna be in space.
    SceneTable["-7100_28"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble47.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey.
    SceneTable["-7100_29"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble89.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey.
    SceneTable["-7100_30"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble90.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey.
    SceneTable["-7100_31"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble91.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey.
    SceneTable["-7100_32"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble92.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey.
    SceneTable["-7100_33"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble93.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey lady.
    SceneTable["-7100_34"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble94.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Lady.
    SceneTable["-7100_35"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble95.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Lady.
    SceneTable["-7100_36"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble99.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey lady.
    SceneTable["-7100_37"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb30.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey.
    SceneTable["-7100_38"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb31.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Lady.
    SceneTable["-7100_39"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb32.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey lady. Lady.
    SceneTable["-7100_40"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb33.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey.
    SceneTable["-7100_41"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb34.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Lady.
    SceneTable["-7100_42"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb35.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space.
    SceneTable["-7100_43"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble48.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space.
    SceneTable["-7100_44"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble49.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Ohhhh, space.
    SceneTable["-7100_45"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble50.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_46"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble51.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --[humming]
    SceneTable["-7100_47"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble52.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_48"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble53.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_49"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble54.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space...
    SceneTable["-7100_50"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble59.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_51"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble57.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_52"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble68.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_53"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble70.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --I'm going to space.
    SceneTable["-7100_54"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble71.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space!
    SceneTable["-7100_55"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble73.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space!
    SceneTable["-7100_56"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble83.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Hey hey hey hey hey!
    SceneTable["-7100_57"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble88.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space!
    SceneTable["-7100_58"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble98.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space.
    SceneTable["-7100_59"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble100.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_60"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble60.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_61"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babble61.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_62"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb01.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_63"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb02.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_64"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb03.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --I love space.
    SceneTable["-7100_65"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb04.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_66"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb05.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_67"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb06.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_68"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb07.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Gotta go to space.
    SceneTable["-7100_69"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb08.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Gonna be in space.
    SceneTable["-7100_70"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb09.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_71"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb10.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_72"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb11.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_73"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb12.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Going to space.
    SceneTable["-7100_74"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb13.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_75"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb14.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_76"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb15.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_77"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb16.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space.
    SceneTable["-7100_78"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb17.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_79"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb18.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_80"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb19.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_81"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb20.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Please go to space.
    SceneTable["-7100_82"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb21.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Space.
    SceneTable["-7100_83"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb22.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --Wanna go to space.
    SceneTable["-7100_84"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb23.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    --(excited gasps)
    SceneTable["-7100_85"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb24.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7100_87"] = {
        vcd = CreateSceneEntity("scenes/npc/core01/babbleb26.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core01",
        noDingOff = true,
    ...
    SceneTable["-7200_01"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact01.vcd"),
        idlerandom = true,
        postdelay = 0.01,
        next = null,
        char = "core02",
        ...
        idleminsecs = 0.5,
        idlemaxsecs = 1.5,
        idlegroup = "core02_babble",
        idleorderingroup = 1
    }

    --The square root of rope is string.
    SceneTable["-7200_02"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact02.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_03"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact07.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_04"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact17.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_05"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact26.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_06"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact41.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_07"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact44.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_08"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact46.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_09"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact47.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_10"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact48.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_11"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact49.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_12"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact50.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_13"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact51.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_14"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact52.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_15"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact53.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_16"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact56.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_17"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact57.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_18"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact60.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_19"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact61.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_20"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact62.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_21"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact63.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_22"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact64.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_23"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact65.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_24"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact66.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_25"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact59.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_26"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact24.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_27"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/fact05.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_28"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/attachedfact04.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7200_29"] = {
        vcd = CreateSceneEntity("scenes/npc/core02/attachedfact20.vcd"),
        postdelay = 0.01,
        next = null,
        char = "core02",
        noDingOff = true,
    ...
    SceneTable["-7300_01"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble01.vcd"),
        postdelay = 0.2,
        next = "-7300_03",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_03"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble03.vcd"),
        postdelay = 0.4,
        next = "-7300_04",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_04"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble04.vcd"),
        postdelay = 0.7,
        next = "-7300_05",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_05"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble05.vcd"),
        postdelay = 0.1,
        next = "-7300_06",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_06"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble06.vcd"),
        postdelay = 0.3,
        next = "-7300_07",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_07"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble07.vcd"),
        postdelay = 0.1,
        next = "-7300_08",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_08"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble08.vcd"),
        postdelay = 0.5,
        next = "-7300_09",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_09"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble09.vcd"),
        postdelay = 0.1,
        next = "-7300_29",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_29"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble29.vcd"),
        postdelay = 0.1,
        next = "-7300_30",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_30"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble30.vcd"),
        postdelay = 0.6,
        next = "-7300_10",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_10"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble10.vcd"),
        postdelay = 0.1,
        next = "-7300_11",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_11"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble11.vcd"),
        postdelay = 0.4,
        next = "-7300_12",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_12"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble12.vcd"),
        postdelay = 0.3,
        next = "-7300_13",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_13"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble13.vcd"),
        postdelay = 0.3,
        next = "-7300_14",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_14"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble14.vcd"),
        postdelay = 0.1,
        next = "-7300_15",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_15"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble15.vcd"),
        postdelay = 0.5,
        next = "-7300_16",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_16"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble16.vcd"),
        postdelay = 0.3,
        next = "-7300_17",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_17"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble17.vcd"),
        postdelay = 0.3,
        next = "-7300_18",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_18"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble18.vcd"),
        postdelay = 0.5,
        next = "-7300_19",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_19"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble19.vcd"),
        postdelay = 0.1,
        next = "-7300_20",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_20"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble20.vcd"),
        postdelay = 0.1,
        next = "-7300_21",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_21"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble21.vcd"),
        postdelay = 0.1,
        next = "-7300_22",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_22"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble22.vcd"),
        postdelay = 0.1,
        next = "-7300_23",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_23"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/babble23.vcd"),
        postdelay = 0.1,
        next = "-7300_29a",
        char = "core03",
        noDingOff = true,
        ...
        fires = {
            {
                entity = "@glados",
                input = "runscriptcode",
                parameter = "sp_a4_finale4_set_thorn()",
                delay = 0.0
            }
        }
    }
    ...
    SceneTable["-7300_29a"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/encouragement13.vcd"),
        postdelay = 0.1,
        next = "-7300_31",
        char = "core03",
        noDingOff = true,
    ...
    --Dun dun dun dun...
    SceneTable["-7300_31"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/singing01.vcd"),
        postdelay = 0.1,
        next = "-7300_32",
        char = "core03",
        noDingOff = true,
    ...
    --Dun dun dun dun...
    SceneTable["-7300_32"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/singing02.vcd"),
        postdelay = 2.1,
        next = "-7300_33",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_33"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/encouragement11.vcd"),
        postdelay = 0.1,
        next = "-7300_35",
        char = "core03",
        noDingOff = true,
    ...
    SceneTable["-7300_35"] = {
        vcd = CreateSceneEntity("scenes/npc/core03/encouragement09.vcd"),
        postdelay = 0.1,
        next = null,
        char = "core03",
        noDingOff = true,
...
function wheatley_monitor_break()
    if curMapName == "sp_a4_finale3" then return end
    --Increment the smash count
    if curMapName == "sp_a4_stop_the_box" then sp_a4_stop_the_box_did_smash = true end
    player:IncWheatleyMonitorDestructionCount()
    local smashes = player:GetWheatleyMonitorDestructionCount()
    if smashes > 0 and smashes < 12 then GladosPlayVcd(600 + smashes) end
end
...
function sp_a4_stop_the_box_check_smash()
    if curMapName == "sp_a4_stop_the_box" then
        if (not sp_a4_stop_the_box_did_smash) and player:GetWheatleyMonitorDestructionCount() > 0 then return true end
    else
        return false
    end
end
...
if curMapName == "sp_a4_finale4" then
    ...
    SceneTable["sp_a4_finale4Epilogue01"] = {
        ...
        fires = {
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_01",
                delay = 0.1,
                fireatstart = true
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_thankGod",
                delay = 0.0,
                fireatstart = true
            },
            {
                entity = "end_glados_lookat_player_relay",
                input = "trigger",
                parameter = "",
                delay = 0.8,
                fireatstart = true
            ...
            {
                entity = "chamber_arm_01",
                input = "setdefaultanimation",
                parameter = "core_arms_lookup_idle_04",
                delay = 0.0,
                fireatstart = true
            },
            {
            ...
            },
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_02",
                delay = 1.1
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_being_caroline_taught_me",
                delay = 1.0
            },
        }
    }
        ...
        fires = {
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_03",
                delay = 0.5
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_surge_of_emotion",
                delay = 0.4
            },
        }
    }
    ...
    SceneTable["sp_a4_finale4Epilogue04"] = {
        ...
        fires = {
            {
                entity = "glados_chamber_cool_light",
                input = "turnon",
                parameter = "",
                delay = 0.0,
                fireatstart = true
            ...
            },
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_04",
                delay = 0.5
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_goodbye_caroline",
                delay = 0.4
            },
        }
    }
    ...
    SceneTable["sp_a4_finale4Epilogue05"] = {
        ...
        fires = {
            ...
            },
            {
                entity = "chamber_arm_01",
                input = "setanimation",
                parameter = "core_arms_lookup_return_04",
                delay = 0.0,
                fireatstart = true
            },
            {
            ...
            },
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_05",
                delay = 0.8
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_easiest_solution",
                delay = 0.7
            },
        }
    }
        ...
        fires = {
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_06",
                delay = 0.3
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_killing_you_is_hard",
                delay = 0.2
            },
        }
    }
        ...
        fires = {
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_07",
                delay = 0.8
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_days_used_to_be_like",
                delay = 0.7
            },
        }
    }
        ...
        fires = {
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_08",
                delay = 0.4
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_then_you_showed_up",
                delay = 0.3
            },
        }
    }
        ...
        fires = {
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_09",
                delay = 0.5
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_you_win",
                delay = 0.4
            },
        }
    }
        ...
        fires = {
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_10",
                delay = 0.7
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_just_go",
                delay = 0.6
            },
            {
                entity = "elevator_tracktrain",
                input = "startforward",
                parameter = "",
                delay = 2
            },
        ...
        fires = {
            {
                entity = "glados_chamber_body",
                input = "setdefaultanimation",
                parameter = "glados_ep_idle_11",
                delay = 1.1
            },
            {
                entity = "glados_chamber_body",
                input = "setanimation",
                parameter = "glados_its_been_fun",
                delay = 1.0
            },
        }
    }
