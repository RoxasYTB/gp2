...
function ENT:Press()
    ...
    if SERVER and GP2 and GP2.ButtonLogging then GP2.ButtonLogging.LogActivation("BOUTON AU SOL SOUTERRAIN", self:GetName(), self:GetPos(), true) end
end
...
function ENT:PressOut()
    ...
    if SERVER and GP2 and GP2.ButtonLogging then GP2.ButtonLogging.LogActivation("BOUTON AU SOL SOUTERRAIN", self:GetName(), self:GetPos(), false) end
end
